...
export function normalizeCategory(category) {
    ...
    if (lower === "authentication" || lower === "auth")
        return "auth";
    if (lower === "organizations" || lower === "organization")
        return "organization";
    ...
    if (lower === "sessions" ||
        ...
        lower === "work sessions")
        return "session";
    if (lower === "entities" || lower === "entity")
        return "entity";
    if (lower === "activities" || lower === "activity")
        return "activity";
    if (lower === "tokens" || lower === "token" || lower === "mcp tokens")
        return "token";
    if (lower === "content" || lower === "contents")
        return "content";
    if (lower === "user context" || lower === "context")
        return "context";
 ...
 * テーブル名からカテゴリを推論する
 */
export function inferCategory(tableName) {
...
//# sourceMappingURL=db-schema-utils.js.map