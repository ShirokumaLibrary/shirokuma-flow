 ...
 */
import type { ScreenItem, ComponentItem, ActionItem, TableItem, FeatureGroup, FeatureMap, ResolvedFeatureMapConfig } from "../commands/generate/feature-map-types.js";
/**
 * アイテムをモジュール別にグループ化
 */
