 ...
 */
export declare function isFileConfig(config: FileValidationConfig | FilePatternValidationConfig): config is FileValidationConfig;
/**
 * FilePatternValidationConfig かどうかを判定
 */
export declare function isPatternConfig(config: FileValidationConfig | FilePatternValidationConfig): config is FilePatternValidationConfig;
