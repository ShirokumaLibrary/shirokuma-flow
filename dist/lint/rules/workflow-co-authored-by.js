 ...
 */
export function validateCoAuthoredBy(commits, severity = "warning") {
    const issues = [];
 ...
 */
export async function checkCoAuthoredBy(severity = "warning") {
    const git = simpleGit();
    const recentCommits = [];
    try {
...
//# sourceMappingURL=workflow-co-authored-by.js.map