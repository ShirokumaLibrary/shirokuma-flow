 ...
 * ```
 */
export function toTableJson(data, columns) {
    if (data.length === 0) {
...
export function formatOutput(data, format, options) {
    switch (format) {
        ...
        case "table-json": {
            ...
            const tableData = toTableJson(arrayData, options.columns);
 ...
 */
function isFrontmatterExcluded(key) {
