 ...
 */
export declare function detectApprovablePlanIssues(planNodes: Array<{
    number?: number;
    title?: string;
    state?: string;
    labels?: {
 ...
 * @returns "items approve {n}" 形式の文字列配列
 */
export declare function detectApprovablePlanIssuesFromIssueData(issues: IssueData[]): string[];
//# sourceMappingURL=detect-approvable-plans.d.ts.map