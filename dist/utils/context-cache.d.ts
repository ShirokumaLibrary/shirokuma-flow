 ...
 */
/** キャッシュのルートディレクトリ */
export declare const CONTEXT_CACHE_ROOT = ".shirokuma/cache";
/** キャッシュサブディレクトリの種別 */
 ...
 */
export declare function readContextCache<T>(subdir: CacheSubdir, key: string): T | null;
/**
 * キャッシュファイルに書き込む。
 ...
 * @param data - 書き込むデータ
 */
export declare function writeContextCache<T>(subdir: CacheSubdir, key: string, data: T): void;
