...
// Factory Function
// =============================================================================
export function createPairsCommand() {
    ...
    pairs
        ...
        const repoOpts = (command.parent?.parent?.opts() ?? {});
        const logger = createPairsLogger(repoOpts.verbose);
    ...
    pairs
        ...
        .action(async (alias, localOpts, command) => {
        const repoOpts = (command.parent?.parent?.opts() ?? {});
        const options = { ...repoOpts, ...localOpts };
    ...
    pairs
        ...
        .action(async (alias, _localOpts, command) => {
        const repoOpts = (command.parent?.parent?.opts() ?? {});
        const options = { ...repoOpts };
        const logger = createPairsLogger(options.verbose);
