 ...
 */
import { diagnoseRepoFailure, } from "../../utils/github.js";
import { getOctokit } from "../../utils/octokit-client.js";
import { getRepoId } from "../../utils/graphql-queries.js";
import { getOwnerNodeId, } from "../../utils/project-utils.js";
import { runGraphQL, getOwner, getRepoName, getProjectId, } from "./helpers.js";
import { cmdSetup } from "./setup.js";
/**
 * create-project subcommand - Project 作成からフィールド設定まで一括実行
 */
export async function cmdCreateProject(options, logger) {
    if (!options.title) {
