...
import { getProjectFields, resolveFieldName, } from "../../utils/project-fields.js";
import { runGraphQL, getOwner, getProjectId, } from "./helpers.js";
/** フィールド色定義（全言語共通） */
const FIELD_COLORS = {
    status: {
        Pending: "GRAY", Backlog: "BLUE", Ready: "GREEN",
        "In Progress": "YELLOW", "On Hold": "RED", Review: "PURPLE",
        Completed: "BLUE", Done: "GREEN", Cancelled: "GRAY",
    },
    priority: {
...
const SETUP_LOCALES = {
    ja: {
        status: {
            Pending: "新規・保留中", Backlog: "やることリスト",
            Ready: "着手可能", "In Progress": "作業中",
            "On Hold": "中断中", Review: "レビュー待ち",
            Completed: "作業完了・PR 作成済み", Done: "完了", Cancelled: "キャンセル",
        },
    ...
    en: {
        status: {
            Pending: "New or blocked", Backlog: "To do list",
            Ready: "Ready to start", "In Progress": "Working on it",
            "On Hold": "On hold", Review: "Awaiting review",
            Completed: "PR created, awaiting review", Done: "Completed", Cancelled: "Cancelled",
        },
 ...
 */
export function buildSingleSelectOptions(colors, descriptions) {
 ...
 */
export async function cmdSetup(options, logger) {
