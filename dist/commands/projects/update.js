...
import { runGraphQL, getOwner, getRepoName, isIssueNumber, parseIssueNumber, getProjectId, fetchItem, findItemByIssueNumber, getIssueByNumber, buildFieldsDict, GRAPHQL_MUTATION_UPDATE_BODY, GRAPHQL_MUTATION_UPDATE_ISSUE, } from "./helpers.js";
/**
 * update subcommand
 */
export async function cmdUpdate(itemIdOrNumber, options, logger) {
    // Validation
