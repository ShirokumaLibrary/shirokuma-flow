...
import { formatOutput, GH_ISSUES_SEARCH_COLUMNS, GH_DISCUSSIONS_SEARCH_COLUMNS, toTableJson, } from "../../../utils/formatters.js";
 ...
 */
function buildCombinedGraphQLQuery(types) {
    const fragments = [];
    if (types.has("issues")) {
        fragments.push(`
...
async function cmdSearchIssues(owner, repo, options, limit, logger) {
...
async function cmdSearchDiscussions(owner, repo, options, limit, logger) {
...
async function cmdSearchCombined(owner, repo, options, limit, logger) {
