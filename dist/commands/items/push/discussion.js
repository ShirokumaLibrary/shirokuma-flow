...
import { GRAPHQL_MUTATION_UPDATE_DISCUSSION, } from "../../discussions/helpers.js";
// =============================================================================
// GraphQL クエリ定義
// =============================================================================
...
// =============================================================================
/** Discussion 本体を push */
export async function pushDiscussionBody(owner, repo, number, localBody, localMeta, _options, logger) {
    // 本文の不正 Unicode 検証
    ...
    const remoteResult = await runGraphQL(GRAPHQL_QUERY_DISCUSSION_TITLE, {
        owner,
        name: repo,
        number,
    });
