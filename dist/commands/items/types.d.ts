...
export interface AddCommentOptions extends ItemsOptions {
    file?: string;
    /** ファイルから読み込んだ本文（resolveFileOption 後に設定） */
    body?: string;
}
/** items add issue サブコマンドのオプション */
export interface AddIssueOptions extends ItemsOptions {
    file?: string;
    /** ファイルから読み込んだ本文（resolveFileOption 後に設定） */
    body?: string;
}
/** items add discussion サブコマンドのオプション */
export interface AddDiscussionOptions extends ItemsOptions {
    file?: string;
    /** ファイルから読み込んだ本文（resolveFileOption 後に設定） */
    body?: string;
}
