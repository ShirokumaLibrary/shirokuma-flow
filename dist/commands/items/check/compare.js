 ...
 */
export function compareSnapshots(localMeta, localBody, remoteTitle, remoteBody, remoteStatus, remotePriority, remoteSize, remoteLabels) {
    const diffs = [];
    // 本文の差分
    ...
    // ラベルの差分（配列比較）
    const localLabels = Array.isArray(localMeta.labels) ? localMeta.labels.sort() : undefined;
