 ...
 */
export function lintCoverageCommand(options) {
...
export function runLintCoverage(options) {
 ...
 * 対応チェックを実行
 */
function checkCoverage(projectPath, sourceFiles, testFilesMap, conventions, _requireSkipReason) {
    const results = [];
    const orphans = [];
