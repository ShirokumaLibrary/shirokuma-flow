...
export function createProjectCommand() {
    const project = new Command("project")
        .description("GitHub Projects V2 管理 (list, get, fields, create, update, delete, add-issue, workflows, setup, setup-metrics)");
    // 共通親オプション
    project
    ...
    project
        ...
        const { cmdList } = await import("../projects/list.js");
    ...
    project
        ...
        const parentOpts = (command.parent?.opts() ?? {});
        const options = { ...parentOpts, ...localOpts };
        const { cmdGet } = await import("../projects/get.js");
        const logger = createActionLogger(options);
    ...
    project
        ...
        const parentOpts = (command.parent?.opts() ?? {});
        const options = { ...parentOpts, ...localOpts };
        const { cmdFields } = await import("../projects/fields.js");
        const logger = createActionLogger(options);
    ...
    project
        ...
        const { cmdCreate } = await import("../projects/create.js");
        const logger = createActionLogger(options);
    ...
    project
        ...
        const parentOpts = (command.parent?.opts() ?? {});
        const options = { ...parentOpts, ...localOpts };
        const { cmdWorkflows } = await import("../projects/workflows.js");
        const logger = createActionLogger(options);
    ...
    project
        ...
        const parentOpts = (command.parent?.opts() ?? {});
        const options = { ...parentOpts, ...localOpts };
        const { cmdSetup } = await import("../projects/setup.js");
        const logger = createActionLogger(options);
    ...
    project
        ...
        const parentOpts = (command.parent?.opts() ?? {});
        const options = { ...parentOpts, ...localOpts };
        const { cmdSetupMetrics } = await import("../projects/setup-metrics.js");
        const logger = createActionLogger(options);
