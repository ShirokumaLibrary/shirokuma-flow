...
function isCompactContentCell(cell) {
    if (cell === ' ')
        return true;
    if (cell.length < 3)
        return false;
...
function isCompactSeparatorCell(cell) {
...
function checkTableRow(line, filePath, lineNumber) {
    const errors = [];
...
export function checkCompactTables(content, filePath) {
