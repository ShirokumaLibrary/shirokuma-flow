...
export function createSkillCommand(): Command {
  ...
  skill
    ...
    .action(async (skillPath: string, _localOpts, command: Command) => {
  ...
  skill
    ...
    .action(async (skillPath: string, localOpts, command: Command) => {
  ...
  skill
    ...
    .action(async (benchmarkDir: string, localOpts, command: Command) => {
