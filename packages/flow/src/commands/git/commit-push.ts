 ...
 *
 * Usage:
 *   shirokuma-flow git commit-push -m "fix: タイポを修正" --issue 1416
 *   shirokuma-flow git commit-push -m "fix: タイポを修正" -f src/index.ts -f src/utils.ts
 */
 ...
 */
export function buildCommitMessage(message: string, issue: number | undefined): string {
 ...
 */
export async function cmdGitCommitPush(
