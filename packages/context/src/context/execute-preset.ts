...
const EXECUTORS: Record<PresetName, PresetExecutor> = {
  'astro-6': astro6,
  'aws-cdk-2': awsCdk2,
  'aws-cli-2': awsCli2,
...
export function loadPresetExecutor(name: string): PresetExecutor | null {
  return Object.hasOwn(EXECUTORS, name) ? EXECUTORS[name as PresetName] : null;
}
