export declare const PACKAGE_NAME = "@shirokuma-library/context";
export type { StrategyMeta, IndividualStrategyMeta, FullSplitStrategyMeta, AnyPresetMeta, } from './types.js';
...
export type { GitHubRepoInfo, GitHubTreeEntry, GitHubTreeEntryWithSha, GitHubRequestOptions, } from './github.js';
