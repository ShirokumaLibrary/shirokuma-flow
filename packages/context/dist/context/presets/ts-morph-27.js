...
export async function execute(params) {
    ...
    await fetchGithubTree({
        ...
        options,
        stats,
        presetName: 'ts-morph-27',
        defaultBranch: meta.branch ?? 'latest',
...
//# sourceMappingURL=ts-morph-27.js.map