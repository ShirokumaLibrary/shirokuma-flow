 ...
 */
export async function fetchMarkdown(url, outFile, force, logger) {
    ...
    try {
        ...
        logger?.debug?.(`fetchMarkdown: ${err.message} — ${url}`);
        return 'failed';
    }
}
async function remoteIsNewer(url, localMtime) {
    try {
...
//# sourceMappingURL=fetch-markdown.js.map