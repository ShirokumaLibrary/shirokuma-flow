...
import { TokenOptimizer, OptimizationIssue } from '../../lint/token-optimizer.js';
import { Issue } from '../../parsers/types/validation.js';
import { Config } from '../../parsers/types/config.js';
...
export async function lintCommand(options: LintOptions): Promise<number> {
