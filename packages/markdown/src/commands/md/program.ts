...
export function createMdCommand(): Command {
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      ...
      setExitCode(await buildCommand(options as any));
    });
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setExitCode(await validateCommand(options as any));
    });
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setExitCode(await analyzeCommand(options as any));
    });
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setExitCode(await lintCommand(options as any));
    });
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setExitCode(await listCommand(options as any));
    });
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setExitCode(await extractCommand(options as any));
    });
  ...
  md
    ...
    .action(async (options: Record<string, unknown>) => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      setExitCode(await batchExtractCommand(options as any));
    });
