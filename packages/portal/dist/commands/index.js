...
import { setExitCode, validateProjectPath } from "@shirokuma-library/lint";
import { mergeCommanderOpts as mergeOpts } from "@shirokuma-library/lint/commander-opts";
...
export function createGenerateCommand() {
    const generate = new Command("generate")
        .description("ドキュメント生成 (all, typedoc, schema, deps, test-cases, portal, coverage, search-index, link-docs, feature-map, overview, screenshots, details, impact, api-tools, i18n, packages)");
