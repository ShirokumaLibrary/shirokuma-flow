 ...
 */
export function inferCategoryFromTestName(itName, description) {
 ...
 * テストケースからカテゴリ別統計を計算
 */
export function computeCategoryStats(cases) {
    const stats = {
        "happy-path": 0,
        auth: 0,
        "error-handling": 0,
 ...
 * @returns モジュール情報
 */
export function inferModuleFromPath(file, framework) {
 ...
 * @returns カテゴリ名
 */
export function getTestCategory(module) {
    switch (module.type) {
        case "action":
 ...
 * 統計サマリーを作成
 */
export function createSummary(fileStats, testCases) {
...
//# sourceMappingURL=test-categorization.js.map